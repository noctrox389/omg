...
function onCreate() -- hi
        ...
        string.lower(songName)  ~= 'pray' and
        string.lower(songName)  ~= 'thend' and
        ...
        string.lower(songName)  ~= 'blazeborn' then
        startSonicCount(string.lower(songName))
        elseif string.lower(songName)  == 'blazeborn' then
            startSonicCount('blazeborn')
        elseif string.lower(songName)  == 'pray' then
            startSonicCount('pray')
        elseif string.lower(songName)  == 'thend' then
        startSonicCount('thend')
